...
function changeAbout(selected){
    const ajax = new XMLHttpRequest()
    ajax.open('GET', './assets/json/about.json')
...
const buttonsAbout = document.querySelectorAll(".buttonAbout");
buttonsAbout.forEach((buttonEvent) => {
    buttonEvent.addEventListener("click", function() {
        buttonsAbout.forEach(button=>button.classList.remove("buttonSelected"));
        this.classList.add("buttonSelected");
        changeAbout(this.value);
    });
});